import { html404 } from './pages/404/404'
import { html500 } from './pages/500/500'
import { htmlChangePassword } from './pages/changePassword/changePassword'
import { htmlChats } from './pages/chats/chats'
import { htmlChangeSettings } from './pages/changeSettings/changeSettings'
import { htmlLogin } from './pages/logIn/login'
import { htmlSignUp } from './pages/signUp/signUp'
import { htmlSettings } from './pages/settings/settings'
